...
const estimatedWorkerBytes = (memoryLimitBytes) => memoryLimitBytes + DEFAULT_WORKER_OVERHEAD_BYTES;
...
const reserveWorkerMemory = (memoryLimitBytes) => {
  if (configuredMaxWorkers !== void 0) {
    return 0;
  }
